...
static z_crc_t FAR crc_table[TBLS][256];
static void make_crc_table OF((void));
#ifdef MAKECRCH
   static void write_table OF((FILE *, const z_crc_t FAR *));
#endif /* MAKECRCH */
/*
...
static void make_crc_table()
{
    ...
    /* write out CRC tables to crc32.h */
    {
        ...
        fprintf(out, "static const z_crc_t FAR ");
...
/* ========================================================================= */
static unsigned long crc32_little(unsigned long crc, const unsigned char FAR *buf, z_size_t len)
{
    register z_crc_t c;
...
/* ========================================================================= */
static unsigned long crc32_big(unsigned long crc, const unsigned char FAR *buf, z_size_t len)
{
    register z_crc_t c;
    register const z_crc_t FAR *buf4;
